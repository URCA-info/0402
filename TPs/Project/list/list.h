...
public:
    ...
    static T dummy;  // pour renvoyer une lvalue lorsque demandé (suppose un constructeur par défaut pour T)
...
template <class T> T list<T>::dummy = 0;
